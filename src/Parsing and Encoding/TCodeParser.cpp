...
AxisExtentionType Parser::getExtentionTypeFromStr(char *buffer, const size_t length, size_t &index)
{
...
bool Parser::getRampTypeFromStr(char *buffer, const size_t length, size_t &index, AxisRampType &rampType)
{
...
bool Parser::parseAxisExtention(char *buffer, const size_t length, size_t &index, AxisExtentionType &extentionType, unsigned long &commandExtention)
{
...
bool Parser::parseAxisRamp(char *buffer, const size_t length, size_t &index, AxisRampType &rampType, AxisRampData &rampIn, AxisRampData &rampOut)
{
    //(<|>|=)(<tangent>(.<weight>))
...
bool Parser::parseAxisRampData(char *buffer, const size_t length, size_t &index, const AxisRampType &rampType, AxisRampData &data)
{
