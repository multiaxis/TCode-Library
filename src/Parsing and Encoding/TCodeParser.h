...
namespace TCodeNamespace
{
    ...
    public:
         ...
         */
        static AxisExtentionType getExtentionTypeFromStr(char *buffer, const size_t length, size_t &startIndex);
         ...
         */
        static void combineRampSegments(AxisRampType startingRampType, float startingRampValue, AxisRampType endingRampType, float endingRampValue, AxisRampType &outRampType, float &rampInValue, float &rampOutValue);
         ...
         */
        static bool parseRampSegment(char *buffer, const size_t length, size_t &startIndex, AxisRampType &rampType, float &rampValue);
         ...
         * @returns returns a true if ramp type was parsed correctly
         */
        static bool getRampTypeFromStr(char *buffer, const size_t length, size_t &startIndex, AxisRampType &rampType, float &rampInValue, float &rampOutValue);
         ...
         */
        static ChannelID getIDFromStr(char *buffer, const size_t length, size_t &startIndex);
         ...
         */
        static CommandType getCommandType(char *buffer, const size_t length, size_t startIndex);
